...
# 1. 데이터 준비
# 경로 설정 (프로젝트의 /data/ 디렉토리 아래에 있는 CSV 파일 경로)
gravity_data_path = r'./data/male_gravity_data.csv'
female_gravity_data_path = r'./data/female_gravity_data.csv'
male_zero_gravity_data_path = r'./data/male_zero_gravity_data.csv'
female_zero_gravity_data_path = r'./data/female_zero_gravity_data.csv'
...
# 모델 저장 경로 설정
model_save_path = './models/my_model.keras'
